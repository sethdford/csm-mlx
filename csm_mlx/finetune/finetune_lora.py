...
def main():
    ...
    if args.train_embeddings and embedding_targets:
        print(f"Warning: Both --train-embeddings and embedding modules in --target-modules detected")
        print(f"Embedding modules in target_modules: {embedding_targets}")
        print(f"This may cause conflicts. Removing embedding modules from target_modules")
    ...
    # Start training
    print(f"Starting LoRA training for {args.epochs} epochs, batch size {args.batch_size}")
