...
def main():
    ...
    if args.freeze_backbone:
        ...
        for param_name, param in model.backbone.parameters().items():
            param.requires_grad = False
    
    if args.freeze_decoder:
        print("Freezing decoder parameters...")
        for param_name, param in model.decoder.parameters().items():
            param.requires_grad = False
    
    # Initialize optimizer
    print(f"Initializing {args.optimizer} optimizer with lr={args.learning_rate}, weight_decay={args.weight_decay}")
    if args.optimizer == "adam":
        optimizer = optim.Adam(learning_rate=args.learning_rate, weight_decay=args.weight_decay)
    elif args.optimizer == "sgd":
        optimizer = optim.SGD(learning_rate=args.learning_rate, weight_decay=args.weight_decay)
